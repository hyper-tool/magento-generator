...
/**
 * Class sendSMSForOrderRmaAuthorized
 * @package D1m\Wesms\Observer
 */
class sendSMSForOrderRmaAuthorized implements ObserverInterface
{
    /**
    ...
    /**
     * sendSMSForOrderPickupRemind constructor.
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)
                ->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_RMA_AUTHORIZED);
