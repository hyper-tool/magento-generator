...
/**
 * Class sendSMSForOrderShipped
 * @package D1m\Wesms\Observer
 */
class sendSMSForOrderShipped implements ObserverInterface
{
    /**
    ...
    /**
     * sendSMSForOrderShip constructor.
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $order->setData('shipping_company',$params['title']);
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)
                ->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_SHIPPED);
