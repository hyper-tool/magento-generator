...
/**
 * Class sendSMSForArrivalNoticeRequest
 * @package D1m\Wesms\Observer
 */
class sendSMSForArrivalNoticeRequest implements ObserverInterface
{
    /**
    ...
    /**
     * sendSMSForArrivalNoticeRequest constructor.
    ...
    /**
     * Send arrival notice request SMS
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $mobile = $observer->getEvent()->getMobile();
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_ARRIVAL_NOTICE_REQUEST);
            $this->_smsHelper->sendSms($smsLog, null, $product);
        }
        return $this;
    }
}
