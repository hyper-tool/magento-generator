...
/**
 * Class sendSMSForOrderRmaApproved
 * @package D1m\Wesms\Observer
 */
class sendSMSForOrderRmaApproved implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)
                ->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_RMA_APPROVED);
