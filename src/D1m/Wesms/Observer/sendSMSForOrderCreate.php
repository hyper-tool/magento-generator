...
/**
 * Class sendSMSForOrderCreate
 * Send notify sms when order creation
 * @package D1m\Wesms\Observer
 */
class sendSMSForOrderCreate implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $order->setData('created_at_prc',$createdAtPrc);
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_NEWS);
