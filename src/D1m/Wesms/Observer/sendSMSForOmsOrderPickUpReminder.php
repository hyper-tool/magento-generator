...
/**
 * Class sendSMSForOmsOrderPickUpReminder
 * @package D1m\Wesms\Observer
 */
class sendSMSForOmsOrderPickUpReminder implements ObserverInterface
{
    /**
    ...
    /**
     * sendSMSForOrderCanceled constructor.
    ...
    /**
     * send order pickUp reminder SMS
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->_smsHelper->validateChinaMobile($mobile)) {
            ...
            $smsLog->setData('number', $mobile)
                ->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_ORDER_PICK_UP_REMINDER);
