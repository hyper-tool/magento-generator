...
/**
 * Class sendSMSForCustomerCreateSuccess
 * @package D1m\Wesms\Observer
 */
class sendSMSForCustomerCreateSuccess implements ObserverInterface
{
    /**
    ...
    /**
     * sendSMSForCustomerCreateSuccess constructor.
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if (!empty($mobile) && $this->_smsHelper->validateChinaMobile($mobile)) {
            //create sms log object
            $smsLog = $this->_logFactory->create();
            $smsLog->setData('number', $mobile)->setData('action_type', \D1m\Wesms\Helper\Sms::SMS_ACTION_REGISTER_SUCCESS);
            $this->_smsHelper->sendSms($smsLog, null, null, null, $customer);
        }
        return $this;
    }
}
