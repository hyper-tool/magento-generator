...
/**
 * Class ForgotpasswordByMobile
 * Forgotpassword by mobile SMS Captcha
...
class ForgotpasswordByMobile extends AbstractModel
{
     ...
     * @var string
     */
    protected $_checkPassTag           = 'forgotpassword_by_mobile_check';

    /**
     *  session tag
     * @var string
     */
    protected $_preSmsValidationNumber = 'validate_forgotpassword_by_mobile';
