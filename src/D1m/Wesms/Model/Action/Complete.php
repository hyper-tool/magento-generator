...
/**
 * Class Complete
 * Order complete notify SMS when order is completed
...
class Complete extends AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/complete_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/complete_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/complete_sms_template_code');
        }
