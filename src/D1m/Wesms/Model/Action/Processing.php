...
class Processing extends AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/processing_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/processing_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/processing_sms_template_code');
        }
