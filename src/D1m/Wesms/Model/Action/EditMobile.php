 ...
 */
class EditMobile extends AbstractModel
{

    /**
     * @var \D1m\Wesms\Model\Action\ValidateCode\EditMobile
     */
    protected $_editMobileValidation;
    ...
    /**
     * EditMobile constructor.
     * @param ValidateCode\EditMobile $editMobileValidation
    ...
    public function __construct(
        \D1m\Wesms\Model\Action\ValidateCode\EditMobile $editMobileValidation,
        ...
        $this->_editMobileValidation = $editMobileValidation;
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/edit_mobile_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/edit_mobile_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/edit_mobile_sms_template_code');
        }
    ...
    public function getSMSContent()
    {
        ...
        $this->_editMobileValidation->setTimeout($this->getLifetime());
        $this->_editMobileValidation->setMobile($mobile);
        $this->_editMobileValidation->generateWord();
        ...
        if ($template && $template->getId())
        {
            ...
            $variables = array(
                'validate'        => $this->_editMobileValidation->setData(array('code'=>$this->_editMobileValidation->getWord($mobile))),
                'date'            => $date
            );
    ...
    public function getJsonParam()
    {
        $mobile = trim($this->getMobile());
        $param = [
            'code' => $this->_editMobileValidation->getWord($mobile),
