...
/**
 * Class Received
 * Received rma product SMS
 * @package D1m\Wesms\Model\Action\Rma
 */
class Received extends \D1m\Wesms\Model\Action\AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/rma_received_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/rma_received_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/rma_received_sms_template_code');
        }
