 ...
 */
class Approved extends \D1m\Wesms\Model\Action\AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/rma_approved_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        if ($this->_enableSendSMS()) {
            return $this->_getStoreConfig('sms_setting/sms_template/rma_approved_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/rma_approved_sms_template_code');
        }
