...
/**
 * Class Refund
 * refund SMS type when order is refund
...
class Refund extends AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/refund_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/refund_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/refund_sms_template_code');
        }
