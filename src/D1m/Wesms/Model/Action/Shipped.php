...
class Shipped extends AbstractModel
{
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/shipped_enable');
    }
    ...
    protected function _getSMSTemplate($store_id = null)
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/shipped_sms_template', $store_id);
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/shipped_sms_template_code');
        }
