...
/**
 * Class InvoiceUrlUpdate
 * @package D1m\Wesms\Model\Action
 */
class InvoiceUrlUpdate extends AbstractModel
{
    /**
     *  sales order
    ...
    /**
     * Get enable config for this SMS type
     * @return bool
     */
    protected function _enableSendSMS()
    {
        return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_update_enable');
    }
    ...
    protected function _getSMSTemplate($store_id = null)
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_update_sms_template', $store_id);
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_update_sms_template_code');
        }
