...
class Invoice extends AbstractModel
{
    ...
    /**
     * @var \D1m\Wesms\Model\Action\ValidateCode\Invoice
     */
    protected $_invoiceValidation;
    ...
    /**
     * Invoice constructor.
     * @param ValidateCode\Invoice $invoiceValidation
    ...
    public function __construct(
        \D1m\Wesms\Model\Action\ValidateCode\Invoice $invoiceValidation,
        ...
        $this->_invoiceValidation = $invoiceValidation;
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/invoice_enable');
    }
    ...
    protected function _getSMSTemplate()
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_sms_template');
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_sms_template_code');
        }
    ...
    public function getSMSContent()
    {
        ...
        $this->_invoiceValidation->setTimeout($this->getLifetime());
        $this->_invoiceValidation->setMobile($mobile);
        $this->_invoiceValidation->generateWord();
        ...
        if ($template && $template->getId())
        {
            ...
            $variables = array(
                'validate'        => $this->_invoiceValidation->setData(array('code'=>$this->_invoiceValidation->getWord($mobile))),
                'date'            => $date
            );
    ...
    public function getJsonParam()
    {
        $mobile = trim($this->getMobile());
        $param = [
            'code' => $this->_invoiceValidation->getWord($mobile),
