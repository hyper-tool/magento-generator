 ...
 */
class InvoiceUrl extends AbstractModel
{
    /**
     *  sales order
    ...
    {
        return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_enable');
    }
    ...
    protected function _getSMSTemplate($store_id = null)
    {
        ...
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_sms_template', $store_id);
        }
    ...
    public function _getSMSTemplateCode()
    {
        if ($this->_enableSendSMS())
        {
            return $this->_getStoreConfig('sms_setting/sms_template/invoice_url_sms_template_code');
        }
